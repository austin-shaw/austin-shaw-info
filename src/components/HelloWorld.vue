<template>
  <v-container>
    ...
    >
      ...
      <v-flex mb-4>
        <!-- <h1 class="display-2 font-weight-bold mb-3">Projects</h1> -->
      ...
      >
        ...
        <p class="subheading font-weight-regular">
          A web app made with Vue.js. Keep track of all of your notes 
          <br>from any device.

          <a href="https://community.vuetifyjs.com" target="_blank">github repo</a>
